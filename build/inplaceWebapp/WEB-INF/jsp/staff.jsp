...
<div class="easyui-panel" title="Новый работник" style="width:100%;max-width:400px;padding:30px 60px;">
    <form id="ff" method="post">
      ...
      <div style="margin-bottom:20px">
        <input class="easyui-textbox" name="address" style="width:100%;height:60px" data-options="label:'Адрес:', multiline:true">
      </div>
      <div style="margin-bottom:20px">
      ...
      <input class="easyui-textbox" name="passport" style="width:100%" data-options="label:'Паспорт:'">
            ...
            <div style="margin-bottom:20px">
            <input class="easyui-textbox" name="login" style="width:100%" data-options="label:'Логин:',required:true">
            </div>
                  <div style="margin-bottom:20px">
                  <input class="easyui-passwordbox" name="password" style="width:100%" data-options="label:'Пароль:',required:true">
                  </div>
