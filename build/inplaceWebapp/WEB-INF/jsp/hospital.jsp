...
<t:html>
    ...
    <div class="easyui-tabs" style="width:95%;">
        <div title=<fmt:message key='department.name'/>
        style="padding:10px">
        <a href="controller?COMMAND=OpenDirectories" class="easyui-linkbutton" data-options="iconCls:'icon-add'">
            <fmt:message key='add'/>
        </a>
        <form id="findsick" method="post" action="controller?COMMAND=FindSickListBy">
            <input type="search" name="firstname" class="easyui-searchbox"
                   data-options="prompt:'<fmt:message key='surname'/>'"
        ...
        <table class="my-table">
            <tr>
                ...
                <th class="my-th">
                    <fmt:message key='datein'/>
                </th>
                <th class="my-th">
                    <fmt:message key='diagnosis'/>
                </th>
                <th class="my-th">
    ...
    <table class="my-table">
        ...
        <c:forEach items="${prescriptionList}" var="prescription">
            <tr>
                ...
                <td class="my-td">
                    <c:if test="${userrole eq 'DOCTOR' or userrole eq 'NURSE'}">
