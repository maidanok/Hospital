...
<fmt:setBundle basename="language"/>
    <div class="easyui-layout" style="width:100%; height:140px;padding:10px;border:0;">
        ...
        <p align ="right"><a href="controller?COMMAND=SetLanguage&language=en">en</a> | <a href="controller?COMMAND=SetLanguage&language=ru">ru</a></p>
        </div>
    </div>
