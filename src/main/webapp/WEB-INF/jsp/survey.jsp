        ...
        <div title="Осмотр пациента №_" style="padding:10px">
            <div class="easyui-layout" style="width:700px;height:350px;">
                <form>
                    ...
                    <div style="margin-bottom:20px">
                    <input class="easyui-datebox" name="surveydate" data-options="label:'Дата осмотра', labelPosition:'top'" style="width:50%;">
                    </div>
                    <div style="margin-bottom:20px">
                    <input class="easyui-textbox" name="description" style="width:50%;height:80px" data-options="label:'Примечания:', labelPosition:'top',multiline:true">
                    </div>
                    <div style="margin-bottom:20px">
