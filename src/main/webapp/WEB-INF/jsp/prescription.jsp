...
<t:html>
    <form>
            ...
            <div style="margin-bottom:20px">
            <input class="easyui-datebox" name="surveydate" data-options="label:'Дата осмотра', labelPosition:'top'" style="width:100%;">
            </div>
            <div style="margin-bottom:20px">
            ...
            <div style="margin-bottom:20px">
            <input class="easyui-numberspinner" value="0" data-options="label:'Количество:',min:1,max:100" style="width:50%;">
            </div>
            <div style="margin-bottom:20px">
            <input class="easyui-textbox" name="description" style="width:100%;height:80px" data-options="label:'Примечания:', labelPosition:'top' ,multiline:true">
            </div>
