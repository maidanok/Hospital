    ...
    <form id="pres" method="post" action="controller?COMMAND=SavePrescription">
        <div class="easyui-panel" title="${prescription.getDescription()}" style="width:100%;max-width:400px;padding:30px 60px;">
            <div style="margin-bottom:20px">
                ...
                <input class="easyui-textbox" name="patient" style="width:100%" data-options="label:'<fmt:message key='patient'/>', editable:0"
                value="${prescription.getSurveyHistory().getSickList().getPatient().getFullName()}">
            </div>
            <div style="margin-bottom:20px">
                <input class="easyui-textbox" name="staff" style="width:100%" data-options="label:'<fmt:message key='doctor'/>', editable:0"
                value="${prescription.getSurveyHistory().getStaff().getFullName()}">
            </div>
            <div style="margin-bottom:20px">
                <input class="easyui-datebox" name="surveydate" data-options="label:'<fmt:message key='surveydate'/>', labelPosition:'top', disabled:1"
            ...
            <div style="margin-bottom:20px">
                ...
                <select class="easyui-combobox" name="prescriptiontype" label="<fmt:message key='prescription'/>" style="width:100%">
            ...
            <div style="margin-bottom:20px">
                <input class="easyui-numberspinner" name="quantity" value="${prescription.getQuantity()}"
                       data-options="label:'<fmt:message key='quantity'/>:',min:1,max:100" style="width:50%;">
            </div>
            <div style="margin-bottom:20px">
                <input class="easyui-textbox" name="description" style="width:100%;height:80px"
                       data-options="label:'<fmt:message key='description'/>:', labelPosition:'top' ,multiline:true" value="${prescription.getDescription()}">
            </div>
